        ...
        fairyStockfish.stdout.on('data', (data) => {
            ...
            if(data.toString().includes('Fen: ')) {
                ...
                currentMoves.forEach(move => {
                    ...
                    if(!jsonData.flagRegion.includes(move.substring(2, 4))) callStack.push(`position fen "${currentFen} b - - 0 1" moves ${move}\nd\n`)
                })
                ...
                if(bestMove.includes('(none)') || bestMove.substring(0, 2) == bestMove.substring(2, 4)) {
                    ...
                    run(`position fen "${currentFen} w - - 0 1" moves ${bestMove}\nd\n`)
                }
            }
        })
